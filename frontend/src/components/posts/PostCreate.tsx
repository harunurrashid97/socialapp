...
export default function PostCreate({ onPostCreated }: { onPostCreated: () => void }) {
  ...
  return (
    <div className="_feed_inner_text_area _padd_t24 _padd_b24 _padd_l24 _padd_r24 _b_radious6 _feed_inner_area _mar_b16">
      <div className="_feed_inner_text_area_box">
        ...
        <div className="form-floating _feed_inner_text_area_box_form">
          ...
          <label 
            ...
            style={{ opacity: content ? 0 : 1, pointerEvents: 'none' }}
          >
            Write something ...
      ...
      {imagePreview && (
        <div className="_img_preview_wrap _mar_b14">
          <img src={imagePreview} alt="Preview" className="_img_preview" />
          <button className="_img_remove_btn" onClick={() => { setImage(null); setImagePreview(null); }}>×</button>
        </div>
      )}
      ...
      <div className="_feed_inner_text_area_bottom">
        ...
        <div className="_feed_inner_text_area_btn" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <select 
            className="_visibility_select form-select" 
            style={{ width: 'auto', padding: '6px 30px 6px 12px', fontSize: '13px', borderRadius: '4px', border: '1px solid #ddd' }}
            value={visibility}
