      ...
      <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
        <div className="container _custom_container">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="_header_nav_profile" onClick={() => setProfileDropOpen(!profileDropOpen)}>
              <div className="_header_nav_profile_image">
                <img src="/assets/images/profile.png" alt="Image" className="_nav_profile_img" />
              </div>
              <div className="_header_nav_dropdown">
                <p className="_header_nav_para">{user?.full_name || 'Dylan Field'}</p>
              ...
              <div className={`_nav_profile_dropdown _profile_dropdown${profileDropOpen ? ' show' : ''}`} style={{ display: profileDropOpen ? 'block' : 'none' }}>
                <div className="_nav_profile_dropdown_info">
                  <div className="_nav_profile_dropdown_image" style={{ border: '2px solid #377DFF', borderRadius: '50%', padding: '2px' }}>
                ...
                <ul className="_nav_dropdown_list">
                  <li className="_nav_dropdown_list_item">
                    <Link href="#0" className="_nav_dropdown_link" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                      ...
                      <svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 9L5 5L1 1" stroke="#C4C4C4" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </Link>
                  </li>
                  <li className="_nav_dropdown_list_item">
                      ...
                      <div className="_nav_drop_info">
                        <span>
                          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 20 20">
                            ...
                            <path d="M10 14V11M10 7H10.01" stroke="#377DFF" strokeWidth="2" strokeLinecap="round"/>
                          </svg>
                        </span>
                        Help & Support
                      </div>
                  ...
                  <li className="_nav_dropdown_list_item">
                    <button type="button" className="_nav_dropdown_link" onClick={handleLogout} style={{ border: 'none', background: 'none', width: '100%', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div className="_nav_drop_info">
                        <span>
            ...
            <div className="row">
              <div className="col-xl-12 col-lg-12 col-md-12">
                <ul className="_mobile_navigation_bottom_list">
                  ...
                  <li className="_mobile_navigation_bottom_item">
                    <button type="button" className="_mobile_navigation_bottom_link" style={{ background: 'none', border: 'none' }} onClick={handleLogout}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="none" viewBox="0 0 19 19">
